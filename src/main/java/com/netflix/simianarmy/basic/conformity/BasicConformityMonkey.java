...
public class BasicConformityMonkey extends ConformityMonkey {
    ...
    public void doMonkeyBusiness() {
        ...
        if (isConformityMonkeyEnabled()) {
            ...
            performConformityCheckForCrawledClusters(clusters);
            if (!leashed) {
    ...
    private void clusterNames(List<Cluster> clusters) {
    ...
    private void performConformityCheckForCrawledClusters(List<Cluster> clusters) {
